...
def text_hook(message):
    match message.text:
        ...
        case '🏋Сайты с задачами, тренажеры':
        ...
        case '✅Остальные полезные ресурсы':
            markup = types.InlineKeyboardMarkup()
        ...
        case 'Образовательные курсы. Python':
            markup = types.InlineKeyboardMarkup()
        ...
        case 'Образовательные курсы. Linux':
            markup = types.InlineKeyboardMarkup()
        ...
        case 'Образовательные курсы. SQL':
            markup = types.InlineKeyboardMarkup()
        ...
        case 'Образовательные курсы. Git':
            markup = types.InlineKeyboardMarkup()
        ...
        case 'Python. Библиотеки, документация и т.д.':
            markup = types.InlineKeyboardMarkup()
        ...
        case 'Linux. Библиотеки, документация и т.д.':
            markup = types.InlineKeyboardMarkup()
